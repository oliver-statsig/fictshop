  ...
  return (
    <div className="py-16 text-center">
      <div className="max-w-xl mx-auto">
        <h1 className="text-4xl font-bold mb-8 text-blue-600">Order Confirmed!</h1>
        <p className="text-2xl mb-12">{message}</p>
        <div className="space-y-4">
          <p className="text-gray-600">
            Our quantum delivery system is calibrating your order. 
            Side effects may include temporal displacement and spontaneous levitation.
          </p>
          <Link 
            href="/"
